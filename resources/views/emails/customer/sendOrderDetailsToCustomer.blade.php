...
<section class="container">
    <div class="col-md-12">
        ...
        <p>Sua compra sera entregue: <strong>{{ ucfirst($address->alias) }} <br /></strong></p>
        <p>Endereço: {{$address->address_1}} {{$address->address_2}} {{$address->city}} {{$address->state_code}}, {{$country->name}}</p>
